...
from modules.Rexi_sheet.table_tool import PandasAgent
...
table_tool_module = reload_module('modules.Rexi_sheet.table_tool')
layout_module = reload_module('modules.layout')
utils_module = reload_module('modules.utils')
sidebar_module = reload_module('modules.sidebar')


st.set_page_config(layout="wide", page_icon="💬", page_title="Rexi | Chat-Bot 🤖")
